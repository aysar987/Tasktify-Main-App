...
export default function TaskSubmittedPage() {
  return (
    <div className="mx-auto max-w-3xl py-8 text-center md:py-16">
      ...
      <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row"><Link href="/activity" className={primaryButton}>Pantau aktivitas</Link><Link href="/market" className={secondaryButton}><Search className="size-5" /> Jelajahi lapak</Link></div>
    </div>
  );
}
